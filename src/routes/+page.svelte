    ...
    {#if !currentUserInformation}
        ...
        >
            <div>
                ...
                />
                <h1>QuiteLean</h1>
                <p class="subtext">A Lean proof assistant problem catalogue</p>
        ...
        >
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>
                            Learning math proofs is <i>hard</i>— especially when
                            you have no one to check them. The way I learned was
                            through crunching dozens of problem sets until I was
                            confident that I understood the proof technique
                            fairly well, but that also required hunting for
                            answers, asking my professors (often to the point
                            that I would annoy them!) for clarification, so I
                            thought of creating a website like Kattis or
                            LeetCode, but for verifying proofs using the
                            <a
